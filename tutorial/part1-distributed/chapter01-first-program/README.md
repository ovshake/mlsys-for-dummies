...
```python
# tutorial/part1-distributed/chapter01-first-program/scripts/verify_setup.py
```
...
Run it with:
```bash
python scripts/hello_distributed.py
```
...
- Original source: [`torch/torch-distributed/readme.md`](../../../torch/torch-distributed/readme.md)
