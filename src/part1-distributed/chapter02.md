...
- Completed [Chapter 1: Your First Distributed Program](./chapter01.md)
...
In [Chapter 3](./chapter03.md), we'll explore **collective operations** in depth—broadcast, scatter, all_gather, and the all-important all_reduce that makes gradient synchronization possible.
