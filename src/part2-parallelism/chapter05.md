...
In [Chapter 6](./chapter06.md), we'll explore **Tensor Parallelism**—splitting individual layers across GPUs. This is how we train layers that are too large for a single GPU even with ZeRO-3.
