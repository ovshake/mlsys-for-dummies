...
- Completed [Chapter 8-9](./chapter08.md) (Server Anatomy, KV Cache)
...
In [Chapter 11](./chapter11.md), we'll explore **Speculative and Constraint Decoding**—using draft models to speed up generation and grammar constraints to ensure structured output.
